# Dataset yolov7_utils and dataloaders
...
from yolov7_utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
    ...
    # Use torch.yolov7_utils.data.DataLoader() if dataset.properties will update during training else InfiniteDataLoader()
...
def extract_boxes(path='../coco/'):  # from yolov7_utils.datasets import *; extract_boxes('../coco128')
