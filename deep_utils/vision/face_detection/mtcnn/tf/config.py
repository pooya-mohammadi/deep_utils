class Config:
    ...
    pnet_cache = 'weights/vision/face_detection/mtcnn/tf/pnet.npy'
    pnet = None
    rnet_url = "https://github.com/Practical-AI/deep_utils/releases/download/0.1.0/rnet.h5"
    rnet_cache = 'weights/vision/face_detection/mtcnn/tf/rnet.npy'
    rnet = None
    onet_url = "https://github.com/Practical-AI/deep_utils/releases/download/0.1.0/onet.h5"
    onet_cache = 'weights/vision/face_detection/mtcnn/tf/onet.npy'
    onet = None
