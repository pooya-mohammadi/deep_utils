...
class CellStem0(nn.Module):
    def __init__(self, stem_filters, num_filters=42):
        ...
        self.conv_1x1.add_module(
            "conv",
            nn.Conv2d(self.stem_filters, self.num_filters,
                      1, stride=1, bias=False),
        )
        self.conv_1x1.add_module(
            "bn", nn.BatchNorm2d(self.num_filters, eps=0.001,
...
class CellStem1(nn.Module):
    def __init__(self, stem_filters, num_filters):
        ...
        self.conv_1x1.add_module(
            "conv",
            nn.Conv2d(2 * self.num_filters, self.num_filters,
                      1, stride=1, bias=False),
        )
        self.conv_1x1.add_module(
            "bn", nn.BatchNorm2d(self.num_filters, eps=0.001,
...
class FirstCell(nn.Module):
    def __init__(
        ...
        self.conv_1x1.add_module(
            "conv",
            nn.Conv2d(in_channels_right, out_channels_right,
                      1, stride=1, bias=False),
        )
        self.conv_1x1.add_module(
            "bn",
            nn.BatchNorm2d(out_channels_right, eps=0.001,
                           momentum=0.1, affine=True),
        )
        ...
        self.path_1.add_module(
            "conv",
            nn.Conv2d(in_channels_left, out_channels_left,
                      1, stride=1, bias=False),
        )
        self.path_2 = nn.ModuleList()
        self.path_2.add_module("pad", nn.ZeroPad2d((0, 1, 0, 1)))
...
class NASNetAMobile(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv0.add_module(
            "bn",
            nn.BatchNorm2d(self.stem_filters, eps=0.001,
                           momentum=0.1, affine=True),
        )
    ...
    def features(self, input):
        ...
        x_cell_15 = F.avg_pool2d(x_cell_15, x_cell_15.size()[
