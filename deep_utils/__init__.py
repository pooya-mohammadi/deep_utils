...
from deep_utils._dummy_objects.dummy_framework import _LazyModule, is_groundingdino_available
...
import_lazy_module('HaarcascadeCV2FaceDetector', 'vision.face_detection.haarcascade.cv2_.haarcascade_cv2_face_detection')
import_lazy_module('show_destroy_cv2', 'utils.opencv_utils.opencv_utils')
import_lazy_module('CVUtils', 'utils.opencv_utils.opencv_utils')
import_lazy_module('b64_to_img', 'utils.opencv_utils.opencv_utils')
import_lazy_module('img_to_b64', 'utils.opencv_utils.opencv_utils')
import_lazy_module('', '')
import_lazy_module('', '')
import_lazy_module('', '')
import_lazy_module('', '')
